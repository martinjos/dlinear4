...
TEST_F(SymbolicFormulaTest, LessForall) {
  ...
  const Formula forall2{forall({var_x_, var_y_, var_z_}, f1_ && (var_z_ > 0))};
  CheckOrdering({forall1, forall2});
}
